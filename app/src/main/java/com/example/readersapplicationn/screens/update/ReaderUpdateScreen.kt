package com.example.readersapplicationn.screens.update
...
import com.example.readersapplicationn.R
...
import com.example.readersapplicationn.utils.formatDate
...
fun ShowBookUpdate(bookInfo: DataOrException<List<MBook>, Boolean, Exception>, bookItemId: String) {
    Row() {
        ...
        if (bookInfo.data != null) {
            val matchingBook = bookInfo.data!!.firstOrNull { mBook ->
                mBook.googleBookId == bookItemId
            }
            ...
            if (matchingBook != null) {
                ...
                // Log a warning if no matching book is found
                Log.w("Warning", "No book found with id: $bookItemId")
                // Handle this case as needed, for example, display an error message
            }
        } else {
            // Log a warning if bookInfo.data is null
            showToast(LocalContext.current, "No book found in the database with this id")
            Log.w("Warning", "Book data is null")
            // Handle this case as needed, for example, display an error message
        }
    }
}
